...
mod tests {
    ...
    fn emits_ptx_header() {
        ...
        let m = MirModule { name: "m".into(), functions: vec![MirFunction { name: "k".into(), hardware: Some(HardwareTarget::Gpu), params: vec![], basic_blocks: vec![BasicBlock { id:0, hardware: Some(ann), instructions: vec![], terminator: Terminator::Return(None) }], attrs: vec![], span: Span { file:"t".into(), line:1, col:1, end_line:1, end_col:1 } }] };
